            ...
            <div class="col">
                <div class="container container-consultant">
                    ...
                    <h4>Tambah Konsultan</h3>
                        ...
                        <div class="form-input">
                            <p>Judul</p>
                            <input class="log-input" type="text" placeholder="Masukan Judul" name="" id="">
                        </div>
                        <div class="form-input">
                            <p>Tag</p>
                            <div class="d-flex gap-3">
                                <input class="log-input" type="text" placeholder="Masukan Tag" name="" id="">
                        ...
                        <div class="form-input">
                            ...
                            <textarea class="log-input" type="text" placeholder="Masukan Deskripsi"
                                style="height: 300px" name="" id=""></textarea>
                        </div>
                        <hr class="line">
                        <div class="form-input">
                            <p>Lokasi</p>
                            ...
                            <div class="card card-info" style="width: 100%;">
                                <ul class="p-0 m-0">
                                    <li style="list-style: inside;">
                                        Silakan masukan URL Streaming dengan benar karena URL Streaming ini yang akan
                                        diterima oleh Pembeli Program kamu setelah transaksi selesai terbayar.
                                    </li>
                                    <li style="list-style: inside;">
                                        Kamu tidak bisa melakukan perubahan URL Streaming setelah kamu selesai melakukan
                                        pembuatan event.
                                    </li>
                                    <li style="list-style: inside;">
                        ...
                        <div class="form-input">
                            ...
                            <div class="date-time gap-3">
                                <div class="col">
                                    <input class="log-input" type="text" placeholder="Masukan">
                                </div>
                                <div class="col">
                                    <input class="log-input" type="text" placeholder="Masukan">
                                </div>
                        ...
                        <div class="form-input d-flex flex-row-reverse">
                            <button class="log-primary-button " type="text" name="" id="">Simpan</button>
                        </div>
                </div>
            </div>
        </div>
