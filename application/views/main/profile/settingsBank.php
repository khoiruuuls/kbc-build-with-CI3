                ...
                <div class="col-md-9 col-12">
                    <div class="container section-pb1">
                        ...
                        <div class="d-flex justify-content-between pb-4">
                            ...
                            <button type="button" class="log-primary-button" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                Tambahkan kartu
                            </button>
                        </div>
                                        ...
                                        <form action="<?= base_url() . 'profile/settingsBank' ?>" method="post">
                                            <div class="row">
                                                <div class="col">
                                                    ...
                                                    <div class="mb-3">
                                                        <input type="number" class="form-control log-input" name="nomer" placeholder="Nomer Kartu">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <input type="varchar" class="form-control log-input" name="bb/tt" placeholder="BB/TT">
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <input type="number" class="form-control log-input" name="cvv" placeholder="CVV">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <div class="mb-3">
                                                        <input type="text" class="form-control log-input" name="name_kartu" placeholder="Nama dikartu">
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
